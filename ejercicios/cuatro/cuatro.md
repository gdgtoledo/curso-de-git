...
Esto permite una enorme flexibilidad a la hora de tener un buen workflow, probar features que varios desarrolladores esten haciendo cada uno distintas partes, o simplemente que la feature de un desarrollador dependa de otra feature que está desarrollando otro desarrollador. 

También podemos hacer un listado mas completo, con las urls a las cuales estan asociados los atajos origin, zero etc...
